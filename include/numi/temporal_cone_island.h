...
#define NUMI_TEMPORAL_CONE_ISLAND_ABI_VERSION 3u
...
#define NUMI_TEMPORAL_CONE_ISLAND_MATRIX_ELEMENTS \
    (NUMI_TEMPORAL_CONE_ISLAND_MAX_ROWS * \
     NUMI_TEMPORAL_CONE_ISLAND_MAX_ROWS)
#define NUMI_TEMPORAL_CONE_PACKED_LOWER_ELEMENTS \
    ((NUMI_TEMPORAL_CONE_ISLAND_MAX_ROWS * \
      (NUMI_TEMPORAL_CONE_ISLAND_MAX_ROWS + 1u)) / 2u)
#define NUMI_TEMPORAL_CONE_ISLAND_MAX_ITERATIONS 1024u

#define NUMI_TEMPORAL_CONE_STREAM_ABI_VERSION 4u
...
enum NumiTemporalConeAssemblyStatusCode : mr_u32 {
    ...
    NUMI_TEMPORAL_CONE_ASSEMBLY_NON_PSD_REGULARIZATION = 7u,
    NUMI_TEMPORAL_CONE_ASSEMBLY_INDEFINITE_OPERATOR = 8u,
};
